...
if __name__ == '__main__':
    ...
    sandy = Storm(path='sandy2.storm', file_format='geoclaw')
    distance_squared = (sandy.eye_location[0,0]-sandy.eye_location[0,1])**2 + (sandy.eye_location[1,0]-sandy.eye_location[1,1])**2
