...
class LongIslandStormJob(batch.HabaneroStormJob):
    ...
    def __init__(self, prefix, 
        ...
        self.rundata.clawdata.tfinal = days2seconds(2.0)
       ...
       # print("######################################")
        ...
        for r in range(len(x_lows)):
            self.rundata.regiondata.regions.append([3,3,self.rundata.clawdata.t0,self.rundata.clawdata.tfinal,x_lows[r],x_lows[r]+widths[r],y_lows[r],y_lows[r]+heights[r]])
...
if __name__ == '__main__':
    ...
    storms = []
    for intensity_index in range(3,7):
        for track_index in range(100):
            n = 9000+100*intensity_index+track_index
            s_n =  Storm(path='randomprojstorms/%s.storm'%(str(n).zfill(4)), file_format = 'geoclaw')
            s_n.ID = n
            storms.append(s_n)
