...
class LongIslandStormJob(batch.HabaneroStormJob):
    ...
    def __init__(self, prefix, 
        ...
        t_peak = peak_times[self.storm_object.ID-4000]
        ...
        self.rundata.clawdata.tfinal = t_intersect + days2seconds(4.0)
       ...
       # print("######################################")
        ...
        self.rundata.amrdata.amr_levels_max = 4
        ...
        if t_peak > 0:
            self.rundata.regiondata.regions.append([4,4,t_peak-days2seconds(1.0),t_peak+days2seconds(1.0),-74.2,-73.7,40.40,48.5])
            self.rundata.regiondata.regions.append([4,4,t_peak-days2seconds(1.0),t_peak+days2seconds(1.0),-74.2,-73.7,40.55,48.5])
...
def run_longisland_job(wind_model  = 'holland80-treruns',
                       amr_level   = 5, 
                       storms     = None):  
    r"""
...
if __name__ == '__main__':
    ...
    storms = []
    peak_times = numpy.loadtxt("peak_times.txt")
    thousand_ids = numpy.load("5000_ids05.npy")
    timeouts = numpy.loadtxt("timeouts.txt")
